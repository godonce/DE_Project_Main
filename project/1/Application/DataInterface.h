...
typedef struct
{
  ...
  unsigned short krOutputSel1[8+1];                  //开关量输入
  unsigned short krOutputSel2[8+1];                  //开关量输入
...
extern const char menu1EndPosParaCn[][MAX_INFO_CHAR];
extern const char menu1EndPosParaEn[][MAX_INFO_CHAR];
extern unsigned short menu1EndPosParaSet[];

extern const char menu2EndPosParaCn[][MAX_INFO_CHAR];
extern const char menu2EndPosParaEn[][MAX_INFO_CHAR];
