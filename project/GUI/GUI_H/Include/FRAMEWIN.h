...
**********************************************************************
*/
FRAMEWIN_Handle FRAMEWIN_Create        (char * pTitle, WM_CALLBACK * cb, int Flags, int x0, int y0, int xSize, int ySize);
...
FRAMEWIN_Handle FRAMEWIN_CreateEx      (int x0, int y0, int xSize, int ySize, WM_HWIN hParent, int WinFlags, int ExFlags, int Id,  char * pTitle, WM_CALLBACK * cb);
FRAMEWIN_Handle FRAMEWIN_CreateUser    (int x0, int y0, int xSize, int ySize, WM_HWIN hParent, int WinFlags, int ExFlags, int Id,  char * pTitle, WM_CALLBACK * cb, int NumExtraBytes);
