...
#define GUI_KEY_TAB               9     /*旋钮按下状态*/    /* ASCII: TAB       Crtl-I */
#define GUI_KEY_BACKTAB           10
#define GUI_KEY_ENTER_BEF         15    /*旋钮抬起动作*/
#define GUI_KEY_ENTER             13    /*旋钮按下动作*/    /* ASCII: ENTER     Crtl-M */
#define GUI_KEY_LEFT              16
#define GUI_KEY_UP                17    /*旋钮向上旋转*/
#define GUI_KEY_RIGHT             18
#define GUI_KEY_DOWN              19    /*旋钮向下旋转*/
#define GUI_KEY_HOME              23
#define GUI_KEY_END               24
#define GUI_KEY_SHIFT             25
#define GUI_KEY_CONTROL           26
#define GUI_KEY_ESCAPE            27     /*旋钮抬起状态*/   /* ASCII: ESCAPE    0x1b   */
...
*       Standard colors
*/
#define GUI_BLUE          0x00FF901E  //0x00FF0000///WY
