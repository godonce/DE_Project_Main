...
{
	SSP_InitStruct->CPHA = SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;
...
void SSP_ConfigStructInit_mlx90363(SSP_CFG_Type *SSP_InitStruct)
{
	SSP_InitStruct->CPHA = SSP_CPHA_SECOND;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;
	SSP_InitStruct->CPOL = SSP_CPOL_HI;
	SSP_InitStruct->ClockRate = 200000;
	SSP_InitStruct->Databit = SSP_DATABIT_8;
	SSP_InitStruct->Mode = SSP_MASTER_MODE;
	SSP_InitStruct->FrameFormat = SSP_FRAME_SPI;
}
void SSP_ConfigStructInit_SPI0(SSP_CFG_Type *SSP_InitStruct)
{
	SSP_InitStruct->CPHA = SSP_CPHA_SECOND;//1;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;
	SSP_InitStruct->CPOL = SSP_CPOL_HI;//SSP_CPOL_LO;//SSP_CPOL_HI;//0
	SSP_InitStruct->ClockRate = 2000000;
	SSP_InitStruct->Databit = SSP_DATABIT_8;
	SSP_InitStruct->Mode = SSP_MASTER_MODE;
	SSP_InitStruct->FrameFormat = SSP_FRAME_SPI;
}
void SSP_ConfigStructInit_SPI0_init(SSP_CFG_Type *SSP_InitStruct)
{
	SSP_InitStruct->CPHA = SSP_CPHA_FIRST;//0;SSP_CPHA_SECOND;//;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;//SSP_CPHA_SECOND;//SSP_CPHA_SECOND;//SSP_CPHA_FIRST;
	SSP_InitStruct->CPOL = SSP_CPOL_HI;//SSP_CPOL_LO;//SSP_CPOL_HI;
	SSP_InitStruct->ClockRate = 2000000;
	SSP_InitStruct->Databit = SSP_DATABIT_8;
	SSP_InitStruct->Mode = SSP_MASTER_MODE;
	SSP_InitStruct->FrameFormat = SSP_FRAME_SPI;
