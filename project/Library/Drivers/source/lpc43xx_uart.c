 ...
 * @return		None
 *******************************************************************************/
void UART_ConfigStructInit3(UART_CFG_Type *UART_InitStruct)
{
...
void UART_ConfigStructInit2(UART_CFG_Type *UART_InitStruct)
{
...
void UART_ConfigStructInit0(UART_CFG_Type *UART_InitStruct)
{
	UART_InitStruct->Baud_rate = 57600;//9600;
	UART_InitStruct->Databits = UART_DATABIT_8;
	UART_InitStruct->Parity = UART_PARITY_NONE;
	UART_InitStruct->Stopbits = UART_STOPBIT_1;
	UART_InitStruct->Clock_Speed = 0;
